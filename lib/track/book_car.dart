...
class BookTrack extends StatefulWidget {

  final Track car;

  BookTrack({@required this.car});

  @override
  _BookCarState createState() => _BookCarState();
}

class _BookCarState extends State<BookTrack> {
                          ...
                          children: [
                            Container(
                              ...
                              child: ListView(
                                ...
                                children: [
                                  buildSpecificationCar("Prix", widget.car.prix, context),
